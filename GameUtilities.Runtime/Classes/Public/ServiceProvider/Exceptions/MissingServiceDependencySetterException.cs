...
namespace ADM87.GameUtilities.ServiceProvider
{
    ...
    public sealed class MissingServiceDependencySetterException(Type implementationType, PropertyInfo property)
        : Exception($"Service dependency {implementationType.Name}.{property.Name} must have a private setter") {}
}